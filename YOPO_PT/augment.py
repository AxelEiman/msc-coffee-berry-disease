...
class PointMosaic(Mosaic):
    def _cat_labels(self, mosaic_labels):
        """Return labels with mosaic border instances clipped. NOTE: CBD added, made compatible with points by not removing zero"""
        ...
        have_area = final_labels['instances'].bbox_areas > 0
